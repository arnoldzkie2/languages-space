...
const UpdateClientCommentAlert = ({ booking }: { booking: BookingProps }) => {
    ...
    const updateClientComment = async (e: React.FormEvent) => {
        ...
        try {
            setIsLoading(true)
            const { data } = await axios.patch('/api/booking/comments/client', {
    ...
    return (
        <AlertDialog open={open} onOpenChange={setOpen}>
            ...
            <AlertDialogContent>
                ...
                <form className='w-full flex flex-col gap-10' onSubmit={updateClientComment}>
...
export default UpdateClientCommentAlert