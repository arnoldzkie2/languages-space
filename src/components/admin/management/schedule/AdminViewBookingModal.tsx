                ...
                <div className='flex w-1/2 flex-col gap-3.5 p-5 border'>
                    ...
                    <div className='flex items-center w-full gap-5'>
                        ...
                        <div className='flex flex-col w-full gap-5'>
                            {permissions?.cancel_booking && <button onClick={(e) => cancelBooking(e)} disabled={isLoading}
                            ...
                            {permissions?.delete_supplier_schedule && <button onClick={(e) => deleteSchedule(e, bookingData?.scheduleID!)} disabled={isLoading}
                                className={`${isLoading ? 'bg-red-500' : 'bg-red-600 hover:bg-red-500'} w-full flex items-center justify-center py-2 rounded-md text-white`}>
