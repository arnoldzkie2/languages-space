...
const Page = () => {
    ...
    const createEarnings = async (e: React.FormEvent) => {
            ...
            <div className={`flex flex-col h-full pb-8 w-full gap-8 ${isSideNavOpen ? 'pl-44' : 'pl-16'}`}>
                ...
                <div className='w-full px-8'>
                    <Card className='w-1/4'>
                        <CardHeader>
                            <CardTitle>{t("supplier.earnings")}</CardTitle>
                        ...
                        <CardContent>
                            <form className='flex flex-col w-full gap-5' onSubmit={createEarnings}>
                                ...
                                <div className='flex w-full items-center gap-5'>
                                    <Button onClick={() => router.push('/admin/manage/supplier')} className='w-full' variant={'ghost'} type='button'>{tt('cancel')}</Button>
