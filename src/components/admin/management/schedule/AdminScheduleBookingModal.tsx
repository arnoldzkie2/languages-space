...
const AdminScheduleBookingModal = () => {
            ...
            <div className='bg-white p-10 shadow-lg flex gap-10 overflow-y-auto w-full h-full relative'>
                ...
                <form className='flex flex-col gap-4 w-1/2' onSubmit={bookSchedule}>
                    ...
                    <div className='flex items-center w-full gap-10'>
                        {permissions?.delete_supplier_schedule && <button type='button'
                            ...
                            {isLoading ? <FontAwesomeIcon icon={faSpinner} width={16} height={16} className='animate-spin' /> : t('schedule.delete')}
                        </button>}

                        {permissions?.create_booking && <button disabled={isLoading}
...
export default AdminScheduleBookingModal