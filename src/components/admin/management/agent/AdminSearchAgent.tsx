import SendPayslipButton from '@/components/super-admin/SendPayslipButton';
...
const AdminSearchAgent: React.FC<Props> = ({ handleSearch, searchQuery }) => {
        ...
        <div className='pt-4 mt-4 border-t border-gray-300 w-full'>
            ...
            <div>
                <div className='flex flex-col text-gray-700 gap-3'>
                    ...
                    {permissions?.send_agent_payslip && <SendPayslipButton sendPayslip={sendAgentPayslip} />}
...
export default AdminSearchAgent;
