...
import { Client, Department } from '@prisma/client'
...
const ViewClientAlert = ({ clientID }: Props) => {
    ...
    return (
        <AlertDialog open={open} onOpenChange={setOpen}>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>{t("client.view")}</AlertDialogTitle>
                        ...
                        <div className='flex gap-5'>
                            ...
                            <div className='flex flex-col gap-2 w-full'>
                                <div className='flex flex-col gap-1'>
                                    <Label htmlFor='ID'>{t('info.id')}</Label>
...
export default ViewClientAlert