...
import DeleteDeductionAlert from './DeleteDeductionsAlert';
import DeleteSelectedDeductionsAlert from './DeleteSelectedDeductionsAlert';

interface Props {
    filteredTable: SupplierDeductions[]
    supplierID: string
}

const SupplierDeductionsTable: React.FC<Props> = ({ filteredTable, supplierID }) => {

    const { selectedDeductions, setSelectedDeductions } = useSupplierDeductionStore()
    ...
    const handleSelection = (agent: SupplierDeductions) => {
    ...
    const selectAllRows = () => {
        ...
        let updatedSelectedClients: SupplierDeductions[]
    ...
    return (
        <div className='flex w-full flex-col'>
            ...
            <DeleteSelectedDeductionsAlert supplierID={supplierID} />
        </div>
    );
};

export default SupplierDeductionsTable;
