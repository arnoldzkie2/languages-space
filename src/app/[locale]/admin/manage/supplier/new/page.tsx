...
const Page = () => {
    ...
    const { isSideNavOpen, isLoading, setIsLoading, setErr, prevProfileKey, setPrevProfileKey, deleteProfile, departmentID } = useGlobalStore()
    ...
    const registerSupplier = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setIsLoading(true)
            const { data } = await axios.post('/api/supplier', { ...updatedFormData, departments: [departmentID] })
