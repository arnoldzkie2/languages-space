                    ...
                    <div className='flex flex-col gap-3 max-h-[500px] overflow-y-auto'>
                        {selectedClients.map(client => (
                            <div className='font-bold text-sm flex flex-col gap-2 p-5 border' key={client.id}>
                                <div>{t('info.id')}: <span className='font-normal text-muted-foreground'>{client.id}</span></div>
                                <div>{t('info.username')}: <span className='font-normal text-muted-foreground'>{client.username}</span></div>
                            </div>
                        ))}
                    </div>
