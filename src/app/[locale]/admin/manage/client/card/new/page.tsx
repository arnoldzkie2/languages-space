...
const Page = () => {
    ...
    const createCard = async (e: any) => {
        ...
        try {
            ...
            if (data.ok) {
                setIsLoading(false)
                router.push('/admin/manage/client/card')
            }
            ...
            <div className={`flex flex-col h-full pb-8 w-full gap-8 ${isSideNavOpen ? 'pl-40' : 'pl-16'}`}>
                ...
                <nav className={`border-b h-20 flex items-center bg-white px-8 justify-between`}>
                    ...
                    <ul className='flex items-center h-full ml-auto gap-5'>
                        ...
                        {permissions?.bind_cards && <Link href={'/admin/manage/client/card/bind'} className='flex items-center gap-1 text-gray-600 justify-center w-32 hover:text-blue-600 cursor-pointer'>
                ...
                <div className='w-full px-8'>
                    ...
                    <form className='w-1/2 flex flex-col gap-10 bg-white text-gray-600 p-10 border' onSubmit={createCard}>
                        ...
                        <div className='flex items-center gap-10 w-full'>
                            <Link href={'/admin/manage/client/card'} className='flex items-center justify-center w-full h-10 rounded-md hover:bg-slate-200 border'>{tt('cancel')}</Link>
